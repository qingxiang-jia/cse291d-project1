...
public interface TestInterface {
   ...
   *        <code>FileNotFoundException</code>. Otherwise, it returns <code>null</code>.
   * @return <code>null</code>.
   * @throws FileNotFoundException If the argument is <code>true</code>.
   * @throws RMIException If the call cannot be complete due to a network error.
   */
   ...
   * <p>
   * <p>
   * The first thread to call this method blocks until a second method wakes it.
   *
   * @throws RMIException If the call cannot be complete due to a network error.
   */
